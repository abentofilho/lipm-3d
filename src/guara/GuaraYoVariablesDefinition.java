...
*/
	...
	public GuaraYoVariablesDefinition(GuaraRobot rob) {
		...
		// vari�veis da junta flutuante do quadril

		bodyJointYOVariables(rob);

		// vari�veis da junta universal do quadril - perna 0
		...
		// vari�veis da junta universal do quadril - perna 1
		...
		// vari�veis da junta universal do quadril - perna 2
		...
		// vari�veis da junta universal do quadril - perna 3
		...
		// vari�veis da pin joint do joelho - perna 0
		...
		// vari�veis da pin joint do joelho - perna 1
		...
		//
		// //vari�veis da pin joint do joelho - perna 2
		//
		...
		//
		// //vari�veis da pin joint do joelho - perna 3
		//
		...
		//
		// //vari�veis da pin joint do tornozelo - perna 0
		//
		...
		//
		// //vari�veis da pin joint do tornozelo - perna 1
		//
		...
		//
		// //vari�veis da pin joint do tornozelo - perna 2
		//
		...
		//
		// //vari�veis da pin joint do tornozelo - perna 3
		//
